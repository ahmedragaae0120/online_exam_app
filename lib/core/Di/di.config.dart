...
import 'package:online_exam_app/data/data_source_impl/change_password_datasource_impl.dart';
import 'package:online_exam_app/data/data_source_impl/get_all_subjects_datasource_impl.dart';
import 'package:online_exam_app/data/data_source_impl/get_profile_datasource_impl.dart';
import 'package:online_exam_app/data/data_source_impl/questions%20_datasource_impl/questions_datasource_impl.dart';
...
import 'package:online_exam_app/data/data_source_impl/update_profile_datasource_impl.dart';
...
import '../../data/data_source_contract/ForgetPassword_dataSourses/VerifyresetcodeRepoDataSource.dart'
    as _i443;
import '../../data/data_source_contract/get_all_exams_on_subject_datasource_contract.dart'
    as _i167;
...
import '../../data/data_source_contract/update_profile_datasource.dart'
    as _i389;
import '../../data/data_source_impl/get_all_exams_on_subject_datasource_impl.dart'
    as _i510;
...
import '../../data/repo_impl/Forget%20Password%20Impl/VerifyresetcodeRepoImpl.dart'
    as _i165;
import '../../data/repo_impl/get_all_exams_on_subject_repo_impl.dart' as _i729;
...
import '../../domain/repo_contract/Forget%20Password%20Repos/verifyResetCodeRepo.dart'
    as _i460;
import '../../domain/repo_contract/get_all_exams_on_subject_repo_contract.dart'
    as _i244;
...
import '../../domain/use_cases/Forget%20Password%20Use%20Cases/verifyResetCodeUseCase.dart'
    as _i644;
import '../../domain/use_cases/get_all_exams_on_subject_usecase.dart' as _i519;
...
import '../../ui/all_exams_on_subject/viewmodel/get_all_exams_on_subject_cubit.dart'
    as _i139;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i705.ProfileDataSourceContract>(
        () => ProfileDataSourceImpl(gh<_i1047.ApiManager>()));
    ...
    gh.factory<_i389.UpdateProfileDataSourceContract>(
        () => UpdateProfileDatasourceImpl(gh<_i1047.ApiManager>()));
    ...
    gh.factory<_i947.ChangePasswordDataSourceContract>(
        () => ChangePasswordDataSourceImpl(gh<_i1047.ApiManager>()));
    ...
    gh.factory<_i1039.GetAllSubjectsDatasourceContract>(
        () => GetAllSubjectsDatasourceImpl(gh<_i1047.ApiManager>()));
    ...
    gh.factory<_i416.QuestionsDatasourceContract>(
        () => QuestionsDatasourceImpl(gh<_i1047.ApiManager>()));
    ...
    gh.factory<_i1072.SignInDataSourceContract>(() => SigninDatasourceImpl(
          gh<_i1047.ApiManager>(),
          gh<_i474.TokenStorageService>(),
        ));
    gh.factory<_i167.GetAllExamsOnSubjectDatasourceContract>(() =>
        _i510.GetAllExamsOnSubjectDatasourceImpl(gh<_i1047.ApiManager>()));
    gh.factory<_i229.SignupRepoContract>(() => _i430.SignupRepoImpl(
        signUpDataSourceContract: gh<_i647.SignUpDataSourceContract>()));
    gh.factory<_i244.GetAllExamsOnSubjectRepoContract>(() =>
        _i729.GetAllExamsOnSubjectRepoImpl(
            gh<_i167.GetAllExamsOnSubjectDatasourceContract>()));
    ...
    gh.factory<_i519.GetAllExamsOnSubjectUsecase>(() =>
        _i519.GetAllExamsOnSubjectUsecase(
            gh<_i244.GetAllExamsOnSubjectRepoContract>()));
    ...
    gh.factory<_i139.AllExamsCubit>(() => _i139.AllExamsCubit(
        getAllExamsOnSubjectUsecase: gh<_i519.GetAllExamsOnSubjectUsecase>()));
